...
import { LayoutDashboard, Users, Target, Gift, Award, TrendingUp, LogOut, Home, ClipboardCheck, Bell } from "lucide-react";
...
const navItems = [
  ...
  { label: "Validasi Laporan", href: "/admin/validasi", icon: ClipboardCheck },
